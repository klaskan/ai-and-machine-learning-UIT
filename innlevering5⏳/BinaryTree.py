...
class BinaryTree:    
    ...
    #Use this methode to delete recursivly
    #For å bruke den i deleteMin() og deleteMax() gjør om navnet på funksjonen til delete()
    def deleteRecursive(self, key):
        self._root = self.deleteRec(self._root, key)

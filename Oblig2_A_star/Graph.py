...
class Graph():
    ...
    #Algoritme for å finne den ikke veide veien (Første algoritmen vi gikk gjennom)
    def unweightedPathDistance(self, startVertexName):
        ...
        # ... and initialize
        for v in self.vertecies: #Så sant startnoden finnes så oppdaterer man avstande, og setter så avstanden til None
            vertex = self.vertecies[v]
            vertex.distance = None #Starter med å sette avstanden lik None
        ...
        self.vertecies[startVertexName].distance = distance = 0 #Startnoden settes til å være Null.
        enqueue(self.vertecies[startVertexName]) #Dytter ut på køen.
